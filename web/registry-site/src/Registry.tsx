...
import { RegistryContext, emptyRegistry } from "./Context";
...
const MaterialUISwitch = styled(Switch)((props: switchProps) => {
  const { theme } = props;
  return {
    width: 62,
    height: 34,
        ...
        >
          ...
          <Box component="h4">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/gideaworx/terraform-exporter"
            >
              Download Terraform Exporter CLI
            </a>
          </Box>
        </AppBar>
